...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('css/contact-us.css')?>">
</head>
<body>
<div class="bg">
  <div class="head-top">
  ...
  <div class="contact-infor">
    <p><img src="<?php echo base_url('img/pos.png')?>"/><span>电子科技大学东二院老年活动中心三楼</span></p>
    <p><img src="<?php echo base_url('img/tel.png')?>"/><span>关工委办公室：028-83203579</span></p>
    <p><img src="<?php echo base_url('img/tel.png')?>"/><span>综合办公室：028-83203568</span></p>
    <p><img src="<?php echo base_url('img/pos.png')?>"/><span>ggw@uestc.edu.cn</span></p>
  </div>
